...
LinkLuaModifier("modifier_anko_senei_ta_jashu_poison", "scripts/vscripts/abilities/heroes/anko/anko_senei_ta_jashu.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_anko_senei_ta_jashu_slow", "scripts/vscripts/abilities/heroes/anko/anko_senei_ta_jashu.lua", LUA_MODIFIER_MOTION_NONE)
