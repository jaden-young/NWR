...
function madara_meteor:Precache( context )
    PrecacheResource( "soundfile", "soundevents/heroes/madara/madara_meteor_cast.vsndevts", context )
    PrecacheResource( "soundfile", "soundevents/heroes/madara/madara_meteor_impact.vsndevts", context )
...
function madara_meteor:LaunchMeteor(target_point)
	...
	Timers:CreateTimer({
		...
		callback = function()
			...
			local explosion_vfx = ParticleManager:CreateParticle("particles/units/heroes/deidara/c4_explo_base.vpcf", PATTACH_ABSORIGIN, caster)
