...
LinkLuaModifier("modifier_kisame_water_prision_caster", "abilities/heroes/kisame/water_prison", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_kisame_water_prision_aura", "abilities/heroes/kisame/water_prison", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_kisame_water_prision_debuff_stacks", "abilities/heroes/kisame/water_prison", LUA_MODIFIER_MOTION_NONE)
