...
LinkLuaModifier("modifier_water_bunshin_bonus_damage", "scripts/vscripts/abilities/heroes/kisame/modifiers/modifier_water_bunshin_bonus_damage.lua", LUA_MODIFIER_MOTION_NONE)
