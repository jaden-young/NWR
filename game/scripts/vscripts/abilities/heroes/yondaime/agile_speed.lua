...
LinkLuaModifier("modifier_yondaime_agile_speed_passive", "abilities/heroes/yondaime/agile_speed", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_yondaime_agile_speed_active", "abilities/heroes/yondaime/agile_speed", LUA_MODIFIER_MOTION_NONE)
