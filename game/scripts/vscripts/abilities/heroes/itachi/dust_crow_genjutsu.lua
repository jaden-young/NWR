LinkLuaModifier("modifier_itachi_crow_bunshin", "abilities/heroes/itachi/dust_crow_genjutsu", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_itachi_crow_bunshin_dummy", "abilities/heroes/itachi/dust_crow_genjutsu", LUA_MODIFIER_MOTION_NONE)
