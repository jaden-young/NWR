LinkLuaModifier("modifier_itachi_amateratsu", "abilities/heroes/itachi/amateratsu", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_itachi_amateratsu_spread_fire_cd", "abilities/heroes/itachi/amateratsu", LUA_MODIFIER_MOTION_NONE)
