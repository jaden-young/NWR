LinkLuaModifier("modifier_itachi_sharingan", "abilities/heroes/itachi/sharingan", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_itachi_sharingan_mr_reduce", "abilities/heroes/itachi/sharingan", LUA_MODIFIER_MOTION_NONE)
