...
LinkLuaModifier( "modifier_onoki_stalagmite_armor", "abilities/heroes/onoki/modifier_onoki_stalagmite_armor", LUA_MODIFIER_MOTION_NONE )

function onoki_stalagmite_armor:Precache( context )
	PrecacheResource( "soundfile", "soundevents/heroes/onoki/onoki_armor_proc.vsndevts", context )
	PrecacheResource( "soundfile", "soundevents/heroes/onoki/onoki_armor_cast.vsndevts", context )
