LinkLuaModifier("modifier_shikamaru_explosive_tag_trap_pre_activation", "abilities/heroes/shikamaru/explosive_tag_trap", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_shikamaru_explosive_tag_trap_active", "abilities/heroes/shikamaru/explosive_tag_trap", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_shikamaru_stun", "scripts/vscripts/abilities/heroes/shikamaru/modifier_shikamaru_stun.lua", LUA_MODIFIER_MOTION_NONE)
