...
LinkLuaModifier("modifier_shikamaru_switching_thinker", "abilities/heroes/shikamaru/shikamaru_switching_technique.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_switching_technique_flash_debuff", "abilities/heroes/shikamaru/shikamaru_switching_technique.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_switching_technique_debuff", "abilities/heroes/shikamaru/shikamaru_switching_technique.lua", LUA_MODIFIER_MOTION_NONE)
