...
LinkLuaModifier("modifier_sai_snake_entanglement_thinker", "abilities/heroes/sai/sai_snake_entanglement.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sai_snake_entanglement_debuff", "abilities/heroes/sai/sai_snake_entanglement.lua", LUA_MODIFIER_MOTION_NONE)
