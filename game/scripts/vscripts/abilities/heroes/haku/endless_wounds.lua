...
LinkLuaModifier("modifier_haku_endless_needles_victim_counter", "abilities/heroes/haku/endless_wounds.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_haku_endless_needles_victim_counter_counter", "abilities/heroes/haku/endless_wounds.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_haku_endless_needles_caster", "abilities/heroes/haku/endless_wounds.lua", LUA_MODIFIER_MOTION_NONE)
