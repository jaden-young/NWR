 neji_byakugan = class({})
 LinkLuaModifier( "modifier_neji_byakugan_buff", "scripts/vscripts/abilities/heroes/neji/neji_byakugan.lua", LUA_MODIFIER_MOTION_NONE )
 LinkLuaModifier( "modifier_neji_byakugan_debuff", "scripts/vscripts/abilities/heroes/neji/neji_byakugan.lua", LUA_MODIFIER_MOTION_NONE )
