...
LinkLuaModifier("modifier_raikage_raigyaku_suihei_on_attack", "abilities/heroes/raikage/raigyaku_suihei", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_raikage_raigyaku_suihei_cooldown", "abilities/heroes/raikage/raigyaku_suihei", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_raikage_raigyaku_suihei_vfx", "abilities/heroes/raikage/raigyaku_suihei", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_raikage_raigyaku_suihei_debuff", "abilities/heroes/raikage/raigyaku_suihei", LUA_MODIFIER_MOTION_NONE)
