...
LinkLuaModifier("modifier_demon_mark", "scripts/vscripts/abilities/heroes/zabuza/zabuza_demon_of_the_hidden_mist.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_demon_unkillable", "scripts/vscripts/abilities/heroes/zabuza/zabuza_demon_of_the_hidden_mist.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_demon_of_the_hidden_mist_slow", "scripts/vscripts/abilities/heroes/zabuza/zabuza_demon_of_the_hidden_mist.lua", LUA_MODIFIER_MOTION_NONE)
